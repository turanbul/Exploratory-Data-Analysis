...
with(refined,plot(Sub_metering_1,col="black",ylab="Energy Sub metering",xlab ="",type = "l",xaxt = "n"))
with(refined,lines(Sub_metering_2,col="red",ylab="Energy Sub metering",xlab ="",type = "l",xaxt = "n"))
with(refined,lines(Sub_metering_3,col="blue",ylab="Energy Sub metering",xlab ="",type = "l",xaxt = "n"))
